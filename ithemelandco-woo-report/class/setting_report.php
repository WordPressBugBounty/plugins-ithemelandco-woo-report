...
//	print_r($_POST);
	...
	foreach($_POST as $key=>$value){
		...
		}elseif($key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'set_default_fields' || $key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'order_status' || $key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'po_custom_fields' || $key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'po_checkout_custom_fields' || $key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'int_recency_point' || $key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'int_frequency_point' || $key==__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'int_monetary_point'
			...
			case 'all_search':
				{
					...
					$args=array('post_type' => 'it_report',
					            'post_status'=>'publish',
					);
