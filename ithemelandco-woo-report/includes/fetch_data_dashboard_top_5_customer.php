...
if($file_used=="sql_table")
{
	...
	$per_page 	= get_option(__IT_REPORT_WCREPORT_FIELDS_PERFIX__.'top_customer_post_per_page',5);;
	...
	,it_postmeta2.meta_value AS 'BillingEmail'
	,it_postmeta3.meta_value AS 'FirstName'
	,it_postmeta5.meta_value AS 'LastName'
	,CONCAT(it_postmeta3.meta_value, ' ',it_postmeta5.meta_value) AS BillingName
	,Count(it_postmeta2.meta_value) AS 'OrderCount'";
