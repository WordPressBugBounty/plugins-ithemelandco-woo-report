...
add_action('plugins_loaded', 'itwrl_init', 90);
...
function itwrl_init()
{
    if (!class_exists('it_report_wcreport_class') && !defined('ITWR_VERSION')) {
        ...
        define('ITWRL_FW_DIR', trailingslashit(trailingslashit(plugin_dir_path(__FILE__)) . 'framework'));
        define('ITWRL_FW_URL', trailingslashit(trailingslashit(plugin_dir_url(__FILE__)) . 'framework'));

        //USE IN INCLUDE
        define('__IT_REPORT_WCREPORT_ROOT_DIR__', dirname(__FILE__));

        define('ITWRL_DASHBOARD_PAGE', admin_url('admin.php?page=wcx_wcreport_plugin_dashboard&parent=dashboard&smenu=dashboard'));
        ...
        define('ITWRL_VIEWS_DIR', trailingslashit(trailingslashit(__IT_REPORT_WCREPORT_ROOT_DIR__) . 'views'));
        ...
        include_once 'framework/analytics/ITWRL_AnalyticsService.php';
        include_once 'framework/analytics/ITWRL_AnalyticsStats.php';
        include_once 'framework/analytics/ITWRL_AnalyticsTracker.php';
        include_once 'framework/active_plugins/ITWRL_ActivePlugins.php';
        include_once 'framework/email_subscription/ITWRL_EmailSubscription.php';
        include_once 'framework/onboarding/ITWRL_Onboarding.php';

        include_once 'class/class-top-banners.php';
        ...
        class it_report_wcreport_class extends it_rpt_datatable_generate
        {
            ...
            public function __construct()
            {
                ...
                ITWRL_AnalyticsTracker::register();
                ITWRL_Onboarding::register();
            ...
            public function wcx_onboarding()
            {
                include_once ITWRL_FW_DIR . "onboarding/views/main.php";
            }
    ...
    where pitems.order_id='$order_id' AND pmeta.meta_key='_wc_eco_fields_value' AND pmeta_p.meta_key='_wc_eco_element_id' AND pmeta_p.meta_value='$field'";
            ...
            public function it_report_setup_menus()
            {
                ...
                if (!ITWRL_Onboarding::is_completed()) {
                    wp_enqueue_style('itwrl-onboarding', ITWRL_FW_URL . 'onboarding/assets/css/onboarding.css', [], ITWRL_VERSION);
                    wp_enqueue_script('itwrl-onboarding', ITWRL_FW_URL . 'onboarding/assets/js/onboarding.js', ['jquery'], ITWRL_VERSION);
                    wp_localize_script('itwrl-onboarding', 'ithemeland_onboarding', [
                        'nonce' => wp_create_nonce('ithemeland_onboarding_action'),
                        'ajaxurl' => admin_url('admin-ajax.php'),
                        'redirecting_text' => esc_html__('Redirecting...', 'ithemelandco-woo-report'),
                        'skip_text' => esc_html__('Skip', 'ithemelandco-woo-report')
                    ]);
